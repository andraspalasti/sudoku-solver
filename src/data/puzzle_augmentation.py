...
def main():
    ...
    csv_dir = Path(args.csv).parents[0]
    ...
    augmentations = [
        ...
        (A.Compose([
            A.ColorJitter(brightness=0.4, contrast=0, saturation=0, hue=0, always_apply=True),
    ...
    for transform, count in augmentations:
        ...
        for ix in ixs:
            ...
            img, bbox = apply(str(csv_dir / img_path), bpoints, transform)
